import {ACESFilmicToneMapping, Clock, DoubleSide, Mesh, PlaneGeometry, ShaderMaterial, SphereGeometry} from "three";
...
export class BaseScene extends BaseInit {
    ...
    addPlan(){
        ...
        const geometry = new SphereGeometry(10, 40,80,80);
