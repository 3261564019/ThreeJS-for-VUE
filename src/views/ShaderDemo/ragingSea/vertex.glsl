...
void main(){
    ...
    float height=sin(uv.x * uFrequency.x + uTime * uSpeed) *
    sin(uv.y * uFrequency.y + uTime * uSpeed) * uBigWave;
    ...
    */
    ...
    for (float i=0.0;i<iterations;i++){
        ...
        **/
        ...
        float noise=cnoise(vec3(uv * uNoiseScale + strength, uTime*uNoiseSpeed))*uNoiseStrength;
