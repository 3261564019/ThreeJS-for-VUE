import {AudioLoader, PerspectiveCamera, Scene, TextureLoader, Vector2, WebGLRenderer} from "three";
...
export class BaseInit {
    ...
    public size:Vector2=new Vector2(660,827);
    ...
    constructor(params: BaseInitParams = {
        ...
        const camera = new THREE.OrthographicCamera(
            -aspectRatio * num,   // left
            aspectRatio * num,    // right
            num,   // top
            -num,  // bottom
            1,    // near
            1000  // far
